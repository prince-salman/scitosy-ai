    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-bunny/50 to-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 md:p-24 text-center">
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="inline-block px-4 py-1.5 rounded-full bg-lilac/10 text-lilac font-medium text-sm mb-6 border border-lilac/20">
            Aksesibilitas Tanpa Batas
          </div>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-zinc-950 mb-6 max-w-4xl mx-auto leading-tight">
            Belajar dengan <span className="text-transparent bg-clip-text bg-gradient-to-r from-lilac to-seafair">Suara</span> dan Sentuhan
          </h1>
